...
export default function AccountPage() {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      setMessage('Contact details saved! Seekers will now see your phone.')
    }
    setSaving(false)
  }
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-500 mb-8">
        Add your phone number so seekers can reach you after revealing the contact.
      </p>
      ...
      <form onSubmit={handleSave} className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <div className="relative">
              <svg className="absolute left-3 top-3 w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 24 24">
        ...
        >
          {saving ? (
            ...
            <>
              <Lock className="w-5 h-5" /> Save Contact Details
            </>
          )}
        </button>
      </form>
